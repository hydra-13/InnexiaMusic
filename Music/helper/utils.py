...
async def stream_end_handler(_, u: Update):
    if isinstance(u, StreamAudioEnded):
        ...
        if op==1:
           await bot.send_message(chat_id, "**Stream Ended.**\n Assistant Leaving Voice Chat Now!")
        elif op==2:
           await bot.send_message(chat_id, "<b>For Some reason Streaming Ended But Songs Are In Queue So Clearing Queue To avoid Over Load On Server.</b>")
        else:
